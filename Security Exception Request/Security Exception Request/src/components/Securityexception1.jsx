...
const SecurityTraining = () => {
  const [exceptionType, setExceptionType] = useState("individual");
  ...
  return (
    <div className="security-training-container">
          ...
          <div className="date-field">
            ...
            <div className="date-input-wrapper">
              ...
              <img
                ...
                onClick={(e) => handleCalendarClick(e, "periodFrom")}
              />
            </div>
          </div>
          <div className="date-field">
            ...
            <div className="date-input-wrapper">
              ...
              <img
                ...
                alt="Calendar"
                className="calendar-icon-svg"
                onClick={(e) => handleCalendarClick(e, "periodTo")}
              />
            </div>
          </div>
          <div className="date-field">
            ...
            <div className="date-input-wrapper">
              ...
              <img
                ...
                alt="Calendar"
                className="calendar-icon-svg"
                onClick={(e) => handleCalendarClick(e, "expiryDate")}
              />
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  {index === 0 && (
                    <img
                      ...
                      src={BlueInfoIcon}
                      alt="Info"
                      className="info-icon-inline blue-info"
                      onClick={() => setShowApprovalPopup(!showApprovalPopup)}
                    />
                  )}
                  {index >= 1 && (
                    <img
