...
import TransferArrowIcon from "../assets/svg/transferarrow.svg";
  ...
  return (
    ...
    >
      ...
      <div className="main-rectangle">
        ...
        {/* Security Exception Heading */}
        <div className="security-exception-heading-section">
          <h3 className="security-exception-main-heading">
            Security Exception
          </h3>
        </div>
        ...
        <div className="form-section">
          ...
          {/* Readonly System Information Display */}
          {isReadOnly && (
            <>
              {/* System Info Table */}
              <div className="system-info-table-container">
                <div className="system-info-table">
                  <div className="table-header">
                    <span style={{ paddingLeft: "16px" }}>Asset/Sample No</span>
                    <span>MAC ID</span>
                    <span>Serial Number</span>
                    <span>IP Address</span>
                    <span>Owner Name</span>
                  ...
                  <div className="table-row">
                    <span>203013255</span>
                    <span>5A-FF-WQ-34-FF-33</span>
                    <span>000123PG2215349R</span>
                    <span>000123PG2215349</span>
                    <span>XXX-XXX-XXX-XXX</span>
                    <span>XXX-XXX-XXX-XXX</span>
                  </div>
                </div>
              ...
              {/* Transfer Workflow Section - Inside grey box */}
              <div className="transfer-workflow-inline">
                <div className="transfer-workflow-inline-content">
                  <img
                    src={TransferWorkflowIcon}
                    alt="Transfer Workflow"
                    className="transfer-workflow-icon-inline"
                  />
                  <span className="workflow-text-inline">
                    Transfer Workflow
                  </span>
                  <img
                    src={TransferArrowIcon}
                    alt="Transfer Arrow"
                    className="transfer-arrow-icon-inline"
                  />
                </div>
              </div>
            </>
